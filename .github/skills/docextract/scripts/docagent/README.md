...
```jsonc
{
  ...
  "items": [
    ...
    },
    {
      ...
      // to_ref は抽出時点の自然キー（F-02 / SCR-03 / 物理名）。specdb の item ID は
      // まだ無いため、後工程（spec-designer）が自然キーで実アイテムへ解決して関係を起こす。
      "location": {}, "keywords": [], "confidence": "high", "added_at": "2026-07-03T…Z"
    }
  ]
}
```
