...
```
python .claude/skills/docextract/scripts/run_docextract.py <入力...> [オプション]
...
DOCEXTRACT_AUTOINSTALL=1 python .claude/skills/docextract/scripts/run_docextract.py <小さな1ファイル> --quiet --json-summary
# 以降は承認フラグ不要・静か
...
```bash
python -m unittest discover -s .claude/skills/docextract/scripts/tests -v
```
